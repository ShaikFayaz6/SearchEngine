...
public class Porter {
   //This method Clean takes a string str and removes all characters that are not letters or digits. It returns a new string containing only the letters and digits from the original string.
  ...
  //This Method checks if word ends with suffix. It also modifies stem to store the part of word without the suffix.
